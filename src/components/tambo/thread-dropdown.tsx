      ...
      <DropdownMenu.Root>
        <DropdownMenu.Trigger asChild>
          <div
            role="button"
            tabIndex={0}
            className="rounded-lg px-1.5 py-0.5 flex items-center gap-2 text-sm border border-border bg-background hover:bg-muted cursor-pointer transition-colors"
        ...
        <DropdownMenu.Portal>
          <DropdownMenu.Content
            className="z-50 min-w-[200px] overflow-hidden rounded-xl border border-border bg-popover p-1.5 text-popover-foreground shadow-lg"
            side="right"
            align="start"
            sideOffset={5}
          >
