...
const EnumField: React.FC<FieldProps> = ({
  ...
  const optionNames: string[] =
    "enumNames" in schema && schema.enumNames ? schema.enumNames : options;
...
export const ElicitationUI: React.FC<ElicitationUIProps> = ({
  ...
  const reqSchema = request.requestedSchema as RequestedSchemaType;
  const singleEntry = isSingleEntryMode(request);
  const fields = useMemo(
    () => Object.entries(reqSchema.properties || {}),
